    ...
    <>
      ...
      {!isOpen && (
        <div className="fixed bottom-6 right-6 z-50">
          ...
          {/* Tooltip */}
          <div className="absolute bottom-full right-0 mb-4 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
            شروع گفتگو
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-[380px] h-[600px] bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/20 z-50 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-500">
          {/* Ultra Modern Header */}
